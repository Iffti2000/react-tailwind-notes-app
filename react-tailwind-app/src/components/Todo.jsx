...
const Todo = () => {
  ...
  return (
    <div className='bg-white place-self-center w-11/12 max-w-xl flex flex-col p-7 min-h-[700px] rounded-xl'>
    ...
    {/* --------- title --------- */}
     ...
     <div className='flex items-center my-7 mx-5 bg-gray-200 rounded-full'>
